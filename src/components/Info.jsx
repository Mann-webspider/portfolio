...
function Info(props) {
  return (
    <div>
      <div className="flex relative  xl:pl-64 pl-1  0 xl:text-[5rem] md:text-[3rem] text-[2rem] uppercase font-[itcBold] border-y-2 border-gray-400 text-text hover:bg-primary hover:text-background duration-300   w-full">
