...
date: 2025-12-27
description: "Clients and servers are separate. The client asks for data or actions, and the server responds. All types of clients make similar requests and get similar responses."
tags: ["nextjs", "react", "web development"]
published: true
author: "Mann"
image: "/images/client-architecture/without.png"
---
...
##### Instead of:
![without api gateway](/images/client-architecture/without.png)

##### you can do:
![with api gateway](/images/client-architecture/with.png)
...
![Event Driven Architechture](/images/client-architecture/EDA.png)
