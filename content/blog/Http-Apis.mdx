...
title: "Http & Api" 
date: 2025-12-28
description: "REST (Representational State Transfer) is an architectural style for building web services that use standard HTTP methods (GET, POST, PUT, DELETE) to perform CRUD operations on resources."
tags: ["HTTP", "REST", "GraphQL", "gRPC","Web Socket", "AMQP"]
published: true
author: "Mann"
image: "/images/http/graphql.png"
---
# Table of content 
...
<br/>
![rest api images](/images/http/rest.png)
...
## GraphQL
![graphql images](/images/http/graphql.png)
